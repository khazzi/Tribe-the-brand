    ...
    <section className="w-full flex xl:flex-row flex-col
     justify-center min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center
       items-start w-full max-xl:padding-x pt-24">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px]
         max-sm:leading-[82px] font-bold">
          <span className="xl:bg-transpaent xl:whitespace-nowrap relative z-10
           pr-10">Latest Arrivals</span>
        <br />
        <span className="text-coral-red inline-block mt-3">Tribe The Brand</span></h1>
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
          Discover stylish Tribe arrivals that offer quality comfort.
        </p>
